...
class AuthWithEmailScreen extends HookWidget {
  const AuthWithEmailScreen({super.key, this.isLoginPageActive = true});

  final bool isLoginPageActive;

  static String path = '/authWithEmail/:isLoginPageActive';
  static String initPath = '/authWithEmail/:true';
  static String name = 'authWithEmail';
  ...
  Widget build(BuildContext context) {
    ...
    log('isLoginPageActive: $isLoginPageActive');
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  '${isLoginPageActive ? 'sign in' : 'sign up'}, '
                  'and start exploring',
                  key: vKey,
                ...
                BrddgeTextFormField(
                  ...
                  onEditingComplete: () {
                    ...
                    log('Email: ${emailInputController.text}, Done editing 🚀');
                  },
                ),
                ...
                BlocConsumer<AuthenticationBloc, AuthenticationState>(
                  listener: (context, state) {
                    ...
                    if (state is AuthenticationSuccess && isLoginPageActive) {
                      context.pushNamed(
                        OTPScreen.name,
                      );
                    }
